...
class FormApp(QDialog):
    def __init__(self):
        ...
        # main layout
        layout = QFormLayout()
        title = QLabel("<h1 style=color:purple;>Device Form</h1>")
        ...
        device_label = QLabel('<h2>&Select Primary Device:</h2>')
        ...
        # adding widgets to theS main window
    ...
    def create_checkboxes(self):
        ...
        checkbox2 = QCheckBox('Instant Messaging')
